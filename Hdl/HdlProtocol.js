...
HdlProtocol.prototype._commandCodes = {
	// Light Control: Scene
	'Scene Control': 0x002,
...
HdlProtocol.prototype.codeOfCommand = function (command) {
	// TODO: return command code
	console.log(this._commandCodes);
};

// var test = new HdlProtocol();
// console.dir(HdlPropocol.prototype);

module.exports = {};	// TODO: return result facade !